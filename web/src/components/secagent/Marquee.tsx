...
const TEXT =
  'SECAGENT · READ-ONLY · HTTP SECURITY HEADERS · WILDCARD CORS · CONTROLLED INVENTORY · LAB DOTFILE · DIRECTORY LISTING · AGENT TRACE · NEMOTRON-3-NANO · MARKDOWN REPORT · BEAVERHACKS 2026 · '
